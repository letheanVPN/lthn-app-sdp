# lethean-vpm-java-client

Lethean VPM
- API version: 1
  - Build date: 2021-07-23T21:16:28.941109+01:00[Europe/London]
...
```xml
<dependency>
  <groupId>org.lthn</groupId>
  <artifactId>lethean-vpm-java-client</artifactId>
  <version>1</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "org.lthn:lethean-vpm-java-client:1"
```
...
* `target/lethean-vpm-java-client-1.jar`
* `target/lib/*.jar`
