...
QString OAIProviderApi::getParamStylePrefix(QString style){
    if(style == "matrix"){
        return ";";
    }else if(style == "label"){
        return ".";
...
QString OAIProviderApi::getParamStyleSuffix(QString style){
    if(style == "matrix"){
        return "=";
    }else if(style == "label"){
        return "";
...
QString OAIProviderApi::getParamStyleDelimiter(QString style, QString name, bool isExplode){
...
void OAIProviderApi::findAll() {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProviderApi::findAllCallback);
...
void OAIProviderApi::findAllCallback(OAIHttpRequestWorker *worker) {
    QString msg;
    ...
    QList<OAIServiceEntity> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    foreach (QJsonValue obj, jsonArray) {
        OAIServiceEntity val;
