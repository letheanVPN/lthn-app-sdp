...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LetheanVpm.ProxySettingsEntity();
  });
  ...
  describe('ProxySettingsEntity', function() {
    it('should create an instance of ProxySettingsEntity', function() {
      ...
      //var instane = new LetheanVpm.ProxySettingsEntity();
      //expect(instance).to.be.a(LetheanVpm.ProxySettingsEntity);
    });
    ...
    it('should have the property endpoint (base name: "endpoint")', function() {
      ...
      //var instance = new LetheanVpm.ProxySettingsEntity();
