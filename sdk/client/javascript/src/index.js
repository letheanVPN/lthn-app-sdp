...
* <pre>
* var LetheanVpnApi = require('index'); // See note below*.
* var xxxSvc = new LetheanVpnApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new LetheanVpnApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new LetheanVpnApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new LetheanVpnApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
