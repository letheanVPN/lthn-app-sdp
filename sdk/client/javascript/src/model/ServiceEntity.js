...
class ServiceEntity {
     ...
     */
    constructor(name, type, cost, downloadSpeed, uploadSpeed, disable) { 
        
        ServiceEntity.initialize(this, name, type, cost, downloadSpeed, uploadSpeed, disable);
    }
     ...
     */
    static initialize(obj, name, type, cost, downloadSpeed, uploadSpeed, disable) { 
        obj['name'] = name;
        obj['type'] = type;
        obj['cost'] = cost;
