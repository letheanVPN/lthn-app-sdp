...
class ApiClient {
  ApiClient({this.basePath = 'https://dvpm.io'}) {
  }
  ...
  static dynamic _deserialize(dynamic value, String targetType, {bool growable}) {
    try {
      switch (targetType) {
        ...
        case 'CertificatesEntity':
          return CertificatesEntity.fromJson(value);
        case 'ProxySettingsEntity':
          return ProxySettingsEntity.fromJson(value);
        case 'ServiceEntity':
          return ServiceEntity.fromJson(value);
        case 'TimeRangeEntity':
          return TimeRangeEntity.fromJson(value);
        case 'VpnSettingsEntity':
          return VpnSettingsEntity.fromJson(value);
        default:
          Match match;
