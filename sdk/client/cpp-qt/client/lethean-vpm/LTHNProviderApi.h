...
#ifndef LTHN_LTHNProviderApi_H
#define LTHN_LTHNProviderApi_H
...
class LTHNProviderApi : public QObject {
    Q_OBJECT

public:
    LTHNProviderApi(const int timeOut = 0);
    ~LTHNProviderApi();
...
private:
    ...
    void findAllCallback(LTHNHttpRequestWorker *worker);

signals:

    void findAllSignal(QList<LTHNServiceEntity> summary);

    void findAllSignalFull(LTHNHttpRequestWorker *worker, QList<LTHNServiceEntity> summary);

    void findAllSignalE(QList<LTHNServiceEntity> summary, QNetworkReply::NetworkError error_type, QString error_str);

    void findAllSignalEFull(LTHNHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
