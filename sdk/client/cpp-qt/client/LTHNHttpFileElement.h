...
#ifndef LTHN_HTTP_FILE_ELEMENT_H
#define LTHN_HTTP_FILE_ELEMENT_H
...
Q_DECLARE_METATYPE(lthn::vpm::client::LTHNHttpFileElement)

#endif // LTHN_HTTP_FILE_ELEMENT_H
