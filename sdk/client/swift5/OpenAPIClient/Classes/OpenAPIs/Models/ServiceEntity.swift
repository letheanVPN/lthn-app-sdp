...
public struct ServiceEntity: Codable, Hashable {
    ...
    public init(id: String? = nil, name: String, type: ModelType, cost: String, firstPrePaidMinutes: Double? = nil, firstVerificationsNeeded: Double? = nil, subsequentPrePaidMinutes: Double? = nil, subsequentVerificationsNeeded: Double? = nil, allowRefunds: Bool? = nil, downloadSpeed: Double, uploadSpeed: Double, proxy: [ProxySettingsEntity]? = nil, vpn: [VpnSettingsEntity]? = nil, validity: TimeRangeEntity? = nil, disable: Bool, certificates: [CertificatesEntity]? = nil) {
        self.id = id
        self.name = name
        self.type = type
        self.cost = cost
