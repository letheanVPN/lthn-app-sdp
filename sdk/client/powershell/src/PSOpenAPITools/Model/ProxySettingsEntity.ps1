...
ProxySettingsEntity<PSCustomObject>
#>

function Initialize-ProxySettingsEntity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProxySettingsEntity' | Write-Debug
...
Convert from JSON to ProxySettingsEntity<PSCustomObject>
...
ProxySettingsEntity<PSCustomObject>
#>
function ConvertFrom-JsonToProxySettingsEntity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProxySettingsEntity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProxySettingsEntity
        $AllProperties = ("endpoint", "port", "terms", "policy")
