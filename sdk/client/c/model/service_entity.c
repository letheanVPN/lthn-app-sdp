...
char* typeservice_entity_ToString(lethean_vpn_api_service_entity_TYPE_e type) {
    char* typeArray[] =  { "NULL", "vpn", "proxy" };
	return typeArray[type];
}

lethean_vpn_api_service_entity_TYPE_e typeservice_entity_FromString(char* type){
...
service_entity_t *service_entity_parseFromJSON(cJSON *service_entityJSON){
    ...
    lethean_vpn_api_service_entity_TYPE_e typeVariable;
