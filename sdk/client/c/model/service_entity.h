...
typedef enum  { lethean_vpn_api_service_entity_TYPE_NULL = 0, lethean_vpn_api_service_entity_TYPE_vpn, lethean_vpn_api_service_entity_TYPE_proxy } lethean_vpn_api_service_entity_TYPE_e;

char* service_entity_type_ToString(lethean_vpn_api_service_entity_TYPE_e type);

lethean_vpn_api_service_entity_TYPE_e service_entity_type_FromString(char* type);
...
typedef struct service_entity_t {
    char *id; // string
    char *name; // string
    lethean_vpn_api_service_entity_TYPE_e type; //enum
    char *cost; // string
...
service_entity_t *service_entity_create(
    char *id,
    char *name,
    lethean_vpn_api_service_entity_TYPE_e type,
    char *cost,
