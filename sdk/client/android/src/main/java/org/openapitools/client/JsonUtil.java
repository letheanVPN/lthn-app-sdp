...
public class JsonUtil {
  ...
  public static Type getListTypeForDeserialization(Class cls) {
    ...
    if ("ProxySettingsEntity".equalsIgnoreCase(className)) {
      return new TypeToken<List<ProxySettingsEntity>>(){}.getType();
    }
    
    if ("ServiceEntity".equalsIgnoreCase(className)) {
      return new TypeToken<List<ServiceEntity>>(){}.getType();
    }
    
    if ("TimeRangeEntity".equalsIgnoreCase(className)) {
      return new TypeToken<List<TimeRangeEntity>>(){}.getType();
    }
    
    if ("VpnSettingsEntity".equalsIgnoreCase(className)) {
      return new TypeToken<List<VpnSettingsEntity>>(){}.getType();
    }
  ...
  public static Type getTypeForDeserialization(Class cls) {
    ...
    if ("ProxySettingsEntity".equalsIgnoreCase(className)) {
      return new TypeToken<ProxySettingsEntity>(){}.getType();
    }
    
    if ("ServiceEntity".equalsIgnoreCase(className)) {
      return new TypeToken<ServiceEntity>(){}.getType();
    }
    
    if ("TimeRangeEntity".equalsIgnoreCase(className)) {
      return new TypeToken<TimeRangeEntity>(){}.getType();
    }
    
    if ("VpnSettingsEntity".equalsIgnoreCase(className)) {
      return new TypeToken<VpnSettingsEntity>(){}.getType();
    }
