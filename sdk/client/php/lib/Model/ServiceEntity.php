...
class ServiceEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['id']) && !preg_match("/[0-9A-F]{1}[0-9A-F]{1}/", $this->container['id'])) {
     ...
     * Sets id
     *
     * @param string|null $id ID of the service
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/[0-9A-F]{1}[0-9A-F]{1}/", $id))) {
