...
var feedbackSchema = {
  ...
  properties: {
    ...
    provider: { type: 'string', minLength: 64, maxLength:64, description: 'Provider ID', pattern:'[A-F0-9+/=]'},
    services: {type: 'string', maxLength: 2, minLength: 2, description: 'Services ID', pattern: '[0-9A-F]{1}[0-9A-F]{1}'},
    client: {type: 'string', maxLength:97, minLength:97, description: 'Client Wallet address', pattern: 'iz[a-zA-Z0-9]'},
  ...
  required: ['id', 'provider', 'services', 'client'],
